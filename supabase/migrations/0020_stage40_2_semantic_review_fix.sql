-- Stage 40.2 semantic review fixes and FK indexes
-- 2026-09-24
...
create index if not exists osint_claim_divergences_item_a_idx
  on public.osint_claim_divergences(item_a);
create index if not exists osint_claim_divergences_item_b_idx
  on public.osint_claim_divergences(item_b);
create index if not exists osint_document_clusters_representative_idx
  on public.osint_document_clusters(representative_item_id);
